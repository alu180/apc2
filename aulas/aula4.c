...
int main() {
  ...
  for (int b = 0; b < 100 * 4; b += 4) {
    // pchar2[b+3] = 0;
    int media = round((pchar3[b + 3] + pchar3[b + 2] + pchar3[b + 1]) / 3.0);
    pchar3[b + 3] = media; // R
    pchar3[b + 2] = media; // G
    pchar3[b + 1] = media; // B
  }
  ...
  for (int lin = 0; lin < 10; lin++) {
    for (int col = 0, colf = 9; col < 10; col++, colf--) {
      if(lin == col) {
        // Diagonal principal
        pchar4[(lin * 10 * 4) + (col * 4) + 3] = 0;   // R = 0
        pchar4[(lin * 10 * 4) + (col * 4) + 2] = 0;   // G = 0
        pchar4[(lin * 10 * 4) + (col * 4) + 1] = 255; // B = 255
        // Diagonal secundária
        pchar4[(lin * 10 * 4) + (colf * 4) + 3] = 0;   // R = 0
        pchar4[(lin * 10 * 4) + (colf * 4) + 2] = 0;   // G = 0
        pchar4[(lin * 10 * 4) + (colf * 4) + 1] = 255; // B = 255
      }
    }
  }
  ...
  for (int lin = 0, linf = 9; lin < 10; lin++, linf--) {
    for (int col = 0; col < 10; col++) {
      if(lin == col) {
        ...
        pchar4[(lin * 10 * 4) + (col * 4) + 1] = 255; // B = 255
        // Diagonal secundária
        pchar4[(linf * 10 * 4) + (col * 4) + 3] = 0;   // R = 0
        pchar4[(linf * 10 * 4) + (col * 4) + 2] = 0;   // G = 0
        pchar4[(linf * 10 * 4) + (col * 4) + 1] = 255; // B = 255
      }
    }
  }
  // insira o seu código acima
